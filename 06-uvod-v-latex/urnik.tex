...
\noindent Spominjam se osnovnošolskih in srednješolskih dni, ko smo vsi z nestrpnostjo pričakovali
...
\[
\text{velikostTabele = številoUrNaDan} \cdot \text{številoDelovnihDni}
\]
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   \begin{enumerate}
      ...
      srečanje$_i$, ki ga sestavlja predmet$_i$, profesor, ki ta predmet predava,
...
spremembo (npr. zamenjava srečanja$_1$ in srečanja$_j$) sedaj shranimo v
